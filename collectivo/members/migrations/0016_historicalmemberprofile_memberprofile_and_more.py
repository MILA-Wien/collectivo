...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('members', '0015_remove_historicalmembership_fees_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='historicalmembership',
            name='profile',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='members.memberprofile'),
        ),
        migrations.AddField(
            model_name='membership',
            name='profile',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='members.memberprofile'),
