...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='PaymentProfile',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='payments', serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='payments.paymentprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
